# RailsAdmin config file. Generated on December 09, 2011 19:47
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Cdc', 'Admin']
  ...
  # config.excluded_models = [Client, Effort, Employee, Project, ProjectEmployee, User]

  # Add models here if you want to go 'whitelist mode':
  config.included_models = [Client, Effort, Employee, Project, User]
  ...
  #   update do; end
  # end
  # config.model Effort do
  #   # Found associations:
  #     configure :project_employee, :belongs_to_association   #   # Found columns:
  #     configure :id, :integer 
  #     configure :project_employee_id, :integer         # Hidden 
  #     configure :estimated, :float 
  #     configure :actual, :float 
  ...
  #   # Found associations:
  #     configure :project_employees, :has_many_association 
  #     configure :projects, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
  ...
  #     configure :rails_version, :string 
  #     configure :ruby_version, :string 
  ...
  #   update do; end
  # end
  # config.model ProjectEmployee do
  #   # Found associations:
  #     configure :project, :belongs_to_association 
  #     configure :employee, :belongs_to_association 
  #     configure :efforts, :has_many_association   #   # Found columns:
  #     configure :id, :integer 
